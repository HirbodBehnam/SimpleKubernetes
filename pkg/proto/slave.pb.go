...
type JobFinishedResult struct {
	...
	Stdout []string                   `protobuf:"bytes,5,rep,name=stdout,proto3" json:"stdout,omitempty"`
	Stderr []string                   `protobuf:"bytes,6,rep,name=stderr,proto3" json:"stderr,omitempty"`
}
...
func (x *JobFinishedResult) GetStdout() []string {
	if x != nil {
		return x.Stdout
	}
	return nil
...
func (x *JobFinishedResult) GetStderr() []string {
	if x != nil {
		return x.Stderr
	}
	return nil
...
var file_pkg_proto_slave_proto_rawDesc = []byte{
	...
	0x6c, 0x74, 0x22, 0xca, 0x01, 0x0a, 0x11, 0x4a, 0x6f, 0x62, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68,
	...
	0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x64, 0x6f, 0x75, 0x74, 0x18,
	0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x64, 0x6f, 0x75, 0x74, 0x12, 0x16, 0x0a,
	0x06, 0x73, 0x74, 0x64, 0x65, 0x72, 0x72, 0x18, 0x06, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x73,
	0x74, 0x64, 0x65, 0x72, 0x72, 0x42, 0x08, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22,
